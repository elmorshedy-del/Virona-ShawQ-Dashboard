...
function NotificationRow({ 
  ...
  const useReceivedTimestamp = source === 'meta' && notification?.store === 'vironax';
  const timestamp = useReceivedTimestamp && notification?.metadata?.received_at
    ? notification.metadata.received_at
