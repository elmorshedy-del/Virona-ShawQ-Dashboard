...
def load_pipeline() -> None:
    ...
    try:
        ...
        # Some repos don't publish fp16 variants; retry without variant.
        pipe = AutoPipelineForInpainting.from_pretrained(MODEL_ID, torch_dtype=dtype)
...
def erase_sdxl():
    try:
        ...
        # Resize crop to SDXL-friendly size (longest side = 1024, multiples of 8).
        ...
        # Composite only inside the mask to avoid unintended edits outside the region.
