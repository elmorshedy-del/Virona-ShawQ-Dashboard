...
- 2026-02-05: Session Intelligence Clarity signals: grouped JS errors by root cause (category + source host + normalized message) and added per-root-cause “top pages impacted” plus an auto-generated recommended fix string to make the output more actionable.
- 2026-02-05: Session Intelligence UI polish: upgraded unknown event label formatting to Title Case (e.g., `checkout_shipping_info_submitted` → “Checkout Shipping Info Submitted”).
