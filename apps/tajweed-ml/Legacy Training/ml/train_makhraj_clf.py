...
from tajweed_ml.models.makhraj import (
    ARABIC_PHONEMES,
    MakhrajClassifier,
    train_makhraj_model,
)

__all__ = ["ARABIC_PHONEMES", "MakhrajClassifier", "train_makhraj_model"]


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--data", required=True, help="Path to training data JSON")
    parser.add_argument("--output", default="artifacts/models/makhraj_classifier.pt")
