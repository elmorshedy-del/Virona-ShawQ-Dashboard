...
def materialize_creative_labels(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="creative-labels-") as temp_dir:
        ...
        qwen_labels = None if force_refresh else cache_fetch(
            scope_type="asset",
        ...
        gemini_labels = None if force_refresh else cache_fetch(
            scope_type="variant",
        ...
        audio_labels = None if force_refresh else cache_fetch(
            scope_type="asset",
            entity_id=prepared.scope_media_hash,
        ...
        claude_labels = None if force_refresh else cache_fetch(
            scope_type="variant",
            entity_id=prepared.variant_id,
            model_name="claude",
