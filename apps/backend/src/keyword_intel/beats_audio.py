...
from .models import BeatsAudioAnalysisResult
from .hf_endpoints import post_hf_inputs


def analyze_beats_audio(
    *,
    endpoint_url: str,
    api_token: str = "",
    ...
    if not endpoint:
        raise RuntimeError("BEATs endpoint is not configured")
    ...
    return BeatsAudioAnalysisResult.model_validate(payload)
